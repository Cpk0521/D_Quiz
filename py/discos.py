...
audiolist = [
    ...
    [26, 'はっちゃけダイアローグ＋クリスマス！', [9], 'EPBCxGeLybM.mp3', [29, 30, 31, 32, 33, 34, 35, 36]],
    [27, 'DIALOGUE＋は上々だ', [9], 'JWt8zVI3lpA.mp3', []],
    [28, 'DIALOGUE＋はまた立ち上がる', [9], '2lFMSMlCRT4.mp3', []],
    [29, 'はっちゃけダイアローグ＋クリスマス！（内山悠里菜 ver.）', [9], 'nR44Y4RLRpg.mp3', [26, 30, 31, 32, 33, 34, 35, 36]],
    [30, 'はっちゃけダイアローグ＋クリスマス！（稗田寧々ver.）', [9], 'OE6LZXc2JAE.mp3', [26, 29, 31, 32, 33, 34, 35, 36]],
    [31, 'はっちゃけダイアローグ＋クリスマス！（守屋亨香ver.）', [9], 'ML9IUOJqH8Q.mp3', [26, 29, 30, 32, 33, 34, 35, 36]],
    [32, 'はっちゃけダイアローグ＋クリスマス！（緒方佑奈ver.）', [9], 'hftnxHg1QN0.mp3', [26, 29, 30, 31, 33, 34, 35, 36]],
    [33, 'はっちゃけダイアローグ＋クリスマス！（鷹村彩花ver.）', [9], 'bePDB2SpnWQ.mp3', [26, 29, 30, 31, 32, 34, 35, 36]],
    [34, 'はっちゃけダイアローグ＋クリスマス！（宮原颯希ver.）', [9], 't0nsWs_5HmE.mp3', [26, 29, 30, 31, 32, 33, 35, 36]],
    [35, 'はっちゃけダイアローグ＋クリスマス！（飯塚麻結ver.）', [9], 'vf79hgyAP2g.mp3', [26, 29, 30, 31, 32, 33, 34, 36]],
    [36, 'はっちゃけダイアローグ＋クリスマス！（村上まなつver.）', [9], '8HAqIJFbiwg.mp3', [26, 29, 30, 31, 32, 33, 34, 35]],
]
