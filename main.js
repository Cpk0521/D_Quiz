var dir_url = 'https://raw.githubusercontent.com/Cpk0521/D_Quiz/SongData'
...
$.getJSON(`${dir_url}/json/DataList.json`, function(data) {
...
function loadquestion(){
    ...
    audio_player = new Howl({
        src: [`${dir_url}/${dir_audio}/${questions.audio}`],
        html5: true,
        onload: ()=>{
    ...
    questions.disco.forEach(e => {
        ...
        let p = `<div class="p-3 text-center">
                    <img class='discoimg' src="${dir_url}/${dir_image}/disco/${data.cover[0].file}">
